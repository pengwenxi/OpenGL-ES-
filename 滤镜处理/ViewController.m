...
//    FilterBar *fileBar = [[FilterBar alloc]initWithFrame:CGRectMake(0, filterBarY, filterBarWidth, filterBarHeight)];
//    fileBar.delegate = self;
//    [self.view addSubview:fileBar];
    
    NSArray *dataList = @[@"无",@"2分屏",@"3分屏",@"4分屏",@"6分屏",@"9分屏"];
//    fileBar.itemList = dataList;
    
    UIScrollView *scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, filterBarY, filterBarWidth, filterBarHeight)];
    
    scrollView.contentSize = CGSizeMake(500, filterBarHeight);
    ...
    for (int i = 0; i<6; i++) {
        ...
        [btn setFrame:CGRectMake(80*i+10, 0, 80, filterBarHeight)];
